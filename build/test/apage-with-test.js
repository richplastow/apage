...
(function() {
  ...
  tudor.equal([
    "Returned object contains expected defaults", '{"title":"Untitled","url":false}', function(mock) {
  ...
  tudor.equal([
    "Returned string is expected length", 8240, function(mock) {
      return mock.render().length;
    }, "Shorter `title` changes string length", 8234, function(mock) {
