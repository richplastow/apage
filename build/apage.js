...
(function() {
  var Article, Main, dirname, filename, filterLine, marked, ordername, page, parseFilename, renderer, script, tidypath, ª, ªA, ªB, ªE, ªF, ªI, ªN, ªO, ªR, ªS, ªU, ªV, ªX, ªclone, ªex, ªhas, ªpopulate, ªtype,
    slice = [].slice;
